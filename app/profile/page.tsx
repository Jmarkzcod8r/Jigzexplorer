...
const Page = () => {
  ...
  const toggleSort = (type: "country" | "score" | "ATH") => {
    if (sortType === type) {
  ...
  return (
    <div className="font-sans flex flex-col items-center min-h-screen p-8 pb-20 sm:p-20 bg-[url('/Bg.png')] bg-cover bg-center">
      ...
      {/* Header */}
      <div className="flex justify-around items-center w-full max-w-md mb-4">
        <button
          onClick={() => router.push("/")}
      ...
      {/* Tickets & Overall */}
      <div className="bg-white shadow-lg rounded-xl p-6 w-full max-w-md text-center mb-4">
      ...
      {/* Countries */}
      <div className="p-4 bg-white shadow rounded max-h-[500px] overflow-y-auto w-full max-w-md">
